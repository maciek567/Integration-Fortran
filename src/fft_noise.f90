program main
    ...
    open(2, file = "../res/cosine.txt", status = 'replace')
    open(3, file = "../res/cosine_rand.txt", status = 'replace')
    open(4, file = "../res/cosine_fft.txt", status = 'replace')
